...
def encode_bytes(patch, bytes):
        bytes[0x2E] = patch['name'][0]
        bytes[0x2F] = patch['name'][1]
        bytes[0x30] = patch['name'][2]
        bytes[0x32] = patch['name'][3]
        ...
        bytes[0x5D] = (patch["OP1"]['Ratio/Fixed']) / 256
        ...
        bytes[0x61] = (patch["OP2"]['Ratio/Fixed']) / 256
        ...
        bytes[0x66] = (patch["OP3"]['Ratio/Fixed']) / 256
        ...
        bytes[0x6B] = (patch["OP4"]['Ratio/Fixed']) / 256
        ...
        bytes[0xAD] = patch["OP4"]['ScalePos (C4=3)']
