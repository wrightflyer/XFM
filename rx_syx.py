...
def decode_bytes(bytes, patch):
    ...
    patch["OP1"]['UpCurve'] = bytes[0xD3]
    patch["OP1"]['DnCurve'] = bytes[0xD4]
    ...
    patch["OP1"]['LGain'] = bytes[0x9C]
    patch["OP1"]['RGain'] = bytes[0x9D]
    ...
    patch["OP2"]['UpCurve'] = bytes[0xD5]
    patch["OP2"]['DnCurve'] = bytes[0xD6]
    ...
    patch["OP2"]['LGain'] = bytes[0xA0]
    patch["OP2"]['RGain'] = bytes[0xA2]
    ...
    patch["OP3"]['UpCurve'] = bytes[0xD7]
    patch["OP3"]['DnCurve'] = bytes[0xD8]
    ...
    patch["OP3"]['LGain'] = bytes[0xA5]
    patch["OP3"]['RGain'] = bytes[0xA6]
    ...
    patch["OP4"]['UpCurve'] = bytes[0xDA]
    patch["OP4"]['DnCurve'] = bytes[0xDB]
    ...
    patch["OP4"]['LGain'] = bytes[0xAA]
    patch["OP4"]['RGain'] = bytes[0xAB]
    patch["OP4"]['LCurve'] = bytes[0xAC] & 0x01
    patch["OP4"]['RCurve'] = bytes[0xAC] & 0x10

    patch["Pitch"]['ALevel'] = bytes[0x97]
    patch["Pitch"]['ATime'] = bytes[0x93]
    patch["Pitch"]['DLevel'] = bytes[0x98]
    patch["Pitch"]['DTime'] = bytes[0x94]
    patch["Pitch"]['SLevel'] = bytes[0x9A]
    patch["Pitch"]['STime'] = bytes[0x95]
    patch["Pitch"]['RLevel'] = bytes[0x9B]
